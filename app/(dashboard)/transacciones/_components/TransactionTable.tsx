    ...
    },
    {
        ...
        cell: ({row}) => (
            <div className={cn("capitalize rounded-lg text-center p-2", 
                row.original.type === "ingreso" && "bg-emerald-400/10 text-emerald-500",
                row.original.type === "gasto" && "bg-red-400/10 text-red-500",
            )}>
                {row.original.type}
            </div>
        )
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 py-4">
                <div className="flex gap-2">
                    {table.getColumn("category") && (
                        <DataTableFacetedFilter title='Categoría' column={table.getColumn("category")} options={categoriesOptions} />
                    )}
                    {table.getColumn("type") && (
                        <DataTableFacetedFilter title='Tipo' column={table.getColumn("type")} options={[
